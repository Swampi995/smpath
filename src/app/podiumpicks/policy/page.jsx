      ...
      <div className="text-center p-8 rounded-lg shadow-lg" style={{ backgroundColor: "#111126" }}>
        <div className="flex flex-col items-center">
          ...
          <div className="relative z-0 text-left">
            ...
            <p>You can choose not to provide certain information, but this may limit your ability to use specific features of the Podium Picks app.</p>
            ...
            <p>By using the Podium Picks mobile app, you agree to this Privacy Policy and the practices described herein.</p>
          </div>
        </div>
      </div>
    </div>
